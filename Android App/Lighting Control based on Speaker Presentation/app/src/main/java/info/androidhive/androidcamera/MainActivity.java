...
public class MainActivity extends AppCompatActivity {
    Button button;
    TextView textView;
    String url = "http://onem2m.iiit.ac.in:443/in-name/Team25_Lighting_dim_control_based_on_speaker_presentation/node_1/la";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = (TextView)findViewById((R.id.kal));
...
//                                JSONObject jsonObject = new JSONObject(response);
                                try {
                                    JSONObject jsonObject = new JSONObject(response);
                                    String m2m = jsonObject.getString("m2m:cin");
                                    JSONObject obj = jsonObject.getJSONObject("m2m:cin");
                                    String output = obj.getString("con");
